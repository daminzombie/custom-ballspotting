...
DEFAULT_DECODE_THRESHOLDS: dict[str, float] = {
    ...
    Action.DRIVE.value: 0.20,
    Action.HEADER.value: 0.20,
    Action.HIGH_PASS.value: 0.20,
    Action.OUT.value: 0.20,
    Action.CROSS.value: 0.20,
    Action.THROW_IN.value: 0.20,
    Action.SHOT.value: 0.20,
    Action.BALL_PLAYER_BLOCK.value: 0.20,
    Action.PLAYER_SUCCESSFUL_TACKLE.value: 0.20,
    Action.FREE_KICK.value: 0.20,
    Action.GOAL.value: 0.20,
}

DEFAULT_DECODE_NMS_WINDOW_FRAMES: dict[str, int] = {
    # Duplicate-decoding windows, not evaluator match tolerances.
    Action.PASS.value: 4,
    Action.DRIVE.value: 4,
    Action.HEADER.value: 4,
    Action.HIGH_PASS.value: 4,
    Action.OUT.value: 8,
    Action.CROSS.value: 4,
    Action.THROW_IN.value: 8,
    Action.SHOT.value: 8,
    Action.BALL_PLAYER_BLOCK.value: 6,
    Action.PLAYER_SUCCESSFUL_TACKLE.value: 6,
